...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    // --- NOTE: This is your original, unchanged logic ---
...
<head>
    ...
    <title>AgoraBoard - Edit Profile</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
    <style>
        /* This is your original CSS, using your --sage color */
        :root {
            --sage: #10b981; 
            --sage-light: #059669; 
            --bg: #FDFDFC; 
...
<div class="container">
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <!-- This now links back to your new profile.php display page -->
            <a href="profile.php" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back to Profile</a>
        </div>
