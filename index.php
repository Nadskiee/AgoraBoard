...
// ✅ Securely get logged-in user info
...
<body>
                ...
                <div class="col-lg-6">
                    <div class="announcement-card p-4 rounded-3 shadow-sm bg-white">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-primary" onclick="window.location.href='events.php?event=community-cleanup'">Read More</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="announcement-card p-4 rounded-3 shadow-sm bg-white">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-outline-primary" onclick="window.location.href='events.php?event=road-closure'">Read More</button>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <!-- Events -->
<div class="col-md-4">
  <a href="event.html" class="text-decoration-none">
    <div class="card shadow-sm border-0 h-100">
      <div class="card-body py-5">
        <i class="fas fa-calendar-alt fa-3x text-success mb-3"></i>
        <h5 class="fw-bold">Events</h5>
        <p class="text-muted">Discover and join upcoming gatherings, workshops, and celebrations.</p>
      </div>
    </div>
  </a>
</div>
                    ...
                    if (i === 0 && j < firstDay) {
                        ...
                        if (events[fullDate]) {
                            ...
                            cell.addEventListener("click", function() {
                                // Redirect to events page with date parameter
                                window.location.href = "events.php?date=" + fullDate;
                            });
                        }
                        date++;
                    }
