...
<head>
    ...
    <style>
        ...
        /* Fix for BS5 radius */
        .input-group > :not(:first-child) { border-top-left-radius: 8px; border-bottom-left-radius: 8px; }
        .input-group > :not(:last-child) { border-top-right-radius: 8px; border-bottom-right-radius: 8px; }
